                ...
                <div className='container flex items-center justify-between h-20'>
                    ...
                    <div className='menu-center-block h-full'>
                        <ul className='menu-nav flex items-center xl:gap-2 h-full'>
                            {data.map((item, index) => (
                                <li key={index} className={`nav-item h-full flex items-center justify-center home ${pathname === item.path ? 'active' : ''} `}>
                                    <Link className='nav-link text-title flex items-center gap-1' href={item.path}>
                                        <span>{item.name}</span>
                                    </Link>
                                </li>
                            ))
